...
function About() {
  ...
  echo <<<EOL
         ...
         \033[01;33mTool Name \033[01;37m:- \033[01;36mIP-Tracer-Pro
         \033[01;33mCodename \033[01;37m:- \033[01;36mpoisk-ls
         \033[01;33mPro  \033[01;37m:- \033[01;36mJade Alan Walker
...
EOL;
  $getact = readline('  IP-Tracer-Pro >> ');
  menu();
}

function upd() {
  logo();
  echo "\n\033[01;32mUpdating IP-Tracer-Pro.........\033[01;37m\n\n";
  sleep(1);
  system("cd ~/ && git clone https://github.com/poisk-ls/IP-Tracer-Pro.git");
  system("cd ~/ && sudo git clone https://github.com/poisk-ls/IP-Tracer-Pro.git");
  system("cd ~/IP-Tracer-Pro && sh install");
  logo();
  echo "\n\033[01;32m              IP-Tracer-Pro updated !!!\033[01;37m\n";
  sleep(1);
  menu();
}
...
function menu() {
  ...
  echo "   \033[01;32m[ \033[01;37m5 \033[01;32m] \033[01;33mUpdate IP-Tracer-Pro.\n";
  echo "   \033[01;32m[ \033[01;37mx \033[01;32m] \033[01;33mExit \n\n\033[00m";
  $inp = readline('  IP-Tracer-Pro >> ');
  if ($inp=="x" || $inp=="exit") {
